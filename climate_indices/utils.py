...
#-----------------------------------------------------------------------------------------------------------------------
def check_dims(which, dims, expected=('lat', 'lon', 'time'), latposition=False):
    """
    Adding more flexibility to the names and order of nc dimensions.

    :param which: short string of which variable we're looking at
    :param dims: tuple of dimensions
    :param expected: tuple of the default expected dimensions
    :param latposition: (optional) boolean, if true, then latitude position returned
